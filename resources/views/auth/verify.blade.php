@extends('layouts.app')
@section('pageTitle')
    <title>'Wedding Photographers Glasgow, Scotland - Wilson McSheffrey Photography - verify</title>
    <meta name="description" content="Creative wedding photographers, Glasgow, Scotland. Scottish Wedding photographers. 
    Covering weddings in Glasgow, Edinburgh, Scottish highlands and more - verify">
@endsection
@section('content')
<div class="container">
